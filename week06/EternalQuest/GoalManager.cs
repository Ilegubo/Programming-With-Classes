...
public class GoalManager
{
    ...
    public void RecordEvent()
    {
        ...
        if (goal is ChecklistGoal cg && cg.IsComplete() && cg.IsComplete())
        {
             // Checking if it just became complete to add bonus logic could be more complex, 
             // but per requirements: award points each time + bonus when finished.
             // We handle basic scoring here:
        }
